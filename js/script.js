document.addEventListener('DOMContentLoaded', () => {
  ...
  (function createPetals() {
    ...
    for (let i = 0; i < petalCount; i++) {
      ...
      petal.style.background = ['#8B4513', '#C47A3A', '#D4AF37', '#3A1A0A', '#FFF8F0'][Math.floor(Math.random() * 5)];
  ...
  const gradients = [
    'linear-gradient(135deg, #8B4513, #C47A3A)',
    'linear-gradient(135deg, #D4AF37, #F0D68A)',
    'linear-gradient(135deg, #3A1A0A, #8B4513)',
    'linear-gradient(135deg, #C47A3A, #FFF8F0)',
    'linear-gradient(135deg, #8B4513, #D4AF37)',
    'linear-gradient(135deg, #3A1A0A, #C47A3A)'
  ];
